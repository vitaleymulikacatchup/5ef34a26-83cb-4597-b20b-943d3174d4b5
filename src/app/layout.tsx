...
export const metadata: Metadata = {
  title: "Tony's Pizzeria - Authentic Italian Wood-Fired Pizza",
  description: "Experience authentic Italian pizza at Tony's Pizzeria. Wood-fired oven, fresh ingredients, family recipes since 1985. Order online or visit us today.",
  keywords: "italian pizza, wood fired pizza, authentic pizza, pizzeria, fresh ingredients, family recipe",
  openGraph: {
    title: "Tony's Pizzeria - Authentic Italian Wood-Fired Pizza",
    description: "Experience authentic Italian pizza at Tony's Pizzeria. Wood-fired oven, fresh ingredients, family recipes since 1985.",
    siteName: "Tony's Pizzeria",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/5953495/pexels-photo-5953495.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Tony's Pizzeria - Authentic Italian Wood-Fired Pizza",
    description: "Experience authentic Italian pizza with wood-fired oven and fresh ingredients since 1985.",
    images: ["https://images.pexels.com/photos/5953495/pexels-photo-5953495.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
